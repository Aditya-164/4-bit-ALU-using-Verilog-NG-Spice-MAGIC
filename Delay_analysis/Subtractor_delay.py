...
V_in_B3 B3 gnd PULSE(0 1.8 0ns 100ps 100ps 30ns 60ns)
    ...
    for l in range(4):
        ...
        fp2 = open("destination_sub.spice",'w')
        fp3 = open("Subtract_delay_analysis.txt",'a')
        mode1 = "RISE"
        mode2 = "RISE"
        mode3 = "FALL"
        mode4 = "FALL"
